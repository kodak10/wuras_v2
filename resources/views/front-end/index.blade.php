        ...
        <div class="row justify-content-center">
            <div class="col-lg-4 col-sm-6 mb-4">
                <div class="banner banner-3 overlay-zoom banner-fixed banner-radius content-middle appear-animate" data-animation-options="{'name': 'fadeInLeftShorter', 'duration': '1s', 'delay': '.2s'}">
                    <figure>
                        <img src="{{ asset('front/images/banner/card_01.webp') }}" alt="banner" width="350" height="177" style="background-color: #1e1e1e;height:177px">
                    </figure>
                    <div class="banner-content">
                            ...
                            <div class="product-details pb-0 pl-0">
                                ...
                                <div class="product-price mb-2">
                                    @if($firstProduct->discount && $firstProduct->discount > 0)
                                        ...
                                        <ins class="new-price">{{ number_format($firstProduct->price - $firstProduct->discount, 0) }} FCFA</ins>
