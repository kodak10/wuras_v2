                        ...
                        <div class="product-details">
                            ...
                            <div class="product-price">
                                @if($relatedProduct->discount && $relatedProduct->discount > 0)
                                    <!-- Calcul du nouveau prix après la réduction -->
                                    <ins class="new-price">
                                        {{ number_format((float)$relatedProduct->price - (float)$relatedProduct->discount, 0, '.', '') }} FCFA
                                    </ins>
                                    <del class="old-price">
                                        {{ number_format((float)$relatedProduct->price, 0, '.', '') }} FCFA
                                    </del>
                                

                                @else
                                    <!-- Afficher uniquement le prix normal si la réduction n'est pas valide -->
                                    <ins class="new-price">{{ number_format($relatedProduct->price, 0, '.', '') }}
                                        FCFA</ins>
                                @endif
                            </div>
