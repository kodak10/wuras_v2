...
return [
    ...
    */
    ...
    | attributs en particulier en utilisant la convention "attribute.rule" pour
    | nommer les lignes ci-dessous. Par exemple, si vous avez une règle de validation
    | pour un attribut "photo", vous pouvez définir un message comme suit :
    |
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Les lignes suivantes permettent de spécifier des noms d'attributs personnalisés
    | qui seront utilisés lors de la validation, par exemple, plutôt que d'afficher
    | "email" dans le message d'erreur, nous afficherons "adresse e-mail".
    |
    */
